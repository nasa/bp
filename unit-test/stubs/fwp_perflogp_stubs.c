 ...
 * @file
 *
 * Auto-Generated stub implementations for functions defined in fwp_perflogp
 * header
 */
...
{
  UT_GenStub_AddParam(BPA_PERFLOGP_Entry, uint32, PerfLogID);
...
{
  UT_GenStub_AddParam(BPA_PERFLOGP_Exit, uint32, PerfLogID);
