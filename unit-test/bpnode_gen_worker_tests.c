...
void Test_BPNode_GenWorkerCreateTasks_Nominal(void)
{
    ...
    UtAssert_STUB_COUNT(OS_BinSemCreate, BPNODE_NUM_GEN_WORKER_TASKS);
    UtAssert_STUB_COUNT(CFE_ES_CreateChildTask, BPNODE_NUM_GEN_WORKER_TASKS);
    UtAssert_STUB_COUNT(OS_BinSemTimedWait, BPNODE_NUM_GEN_WORKER_TASKS);
}
...
void Test_BPNode_GenWorkerCreateTasks_InitSemErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_INIT_SEM_ERR_EID);
    UtAssert_STRINGBUF_EQ("Failed to create the Generic Worker #%d task init semaphore. Error = %d.", BPLIB_EM_EXPANDED_EVENT_SIZE, 
...
void Test_BPNode_GenWorkerCreateTasks_TaskCrErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_CREATE_ERR_EID);
    UtAssert_STRINGBUF_EQ("Failed to create the Generic Worker #%d child task. Error = %d.", BPLIB_EM_EXPANDED_EVENT_SIZE, 
                            context_BPLib_EM_SendEvent[0].Spec, BPLIB_EM_EXPANDED_EVENT_SIZE);
    UtAssert_STUB_COUNT(BPLib_EM_SendEvent, 1);
    UtAssert_STUB_COUNT(OS_BinSemCreate, 1);
...
void Test_BPNode_GenWorkerCreateTasks_TakeSemErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_RUN_ERR_EID);
...
{
    uint8 WorkerId = BPNODE_NUM_GEN_WORKER_TASKS;
    uint8 ExpWorkerId = 0;
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_INIT_INF_EID);
...
{
    uint8 WorkerId = BPNODE_NUM_GEN_WORKER_TASKS;
    uint8 ExpWorkerId = BPNODE_NUM_GEN_WORKER_TASKS;
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_NO_ID_ERR_EID);
...
void Test_BPNode_GenWorker_TaskInit_MatchIdErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_INV_ID_ERR_EID);
...
void Test_BPNode_GenWorker_TaskInit_GiveSemErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_INIT_SEM_TK_ERR_EID);
...
/* Test BPNode_GenWorker_AppMain when app state is started */
...
void Test_BPNode_GenWorker_AppMain_WorkerIdErr(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[1].EventID, BPNODE_GEN_WORKER_UNK_EXIT_CRIT_EID);
...
void Test_BPNode_GenWorker_TaskExit_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPNODE_GEN_WORKER_EXIT_CRIT_EID);
