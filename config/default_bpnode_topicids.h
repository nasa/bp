...
/* Telemetry topic IDs */
#define CFE_MISSION_BPNODE_NODE_MIB_CONFIG_HK_TLM_TOPICID       0x36
#define CFE_MISSION_BPNODE_SOURCE_MIB_CONFIG_HK_TLM_TOPICID     0x37
...
#define CFE_MISSION_BPNODE_NODE_MIB_REPORTS_HK_TLM_TOPICID      0x3C
