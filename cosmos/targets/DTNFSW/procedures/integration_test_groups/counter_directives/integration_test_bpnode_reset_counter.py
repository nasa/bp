...
class integration_test_bpnode_reset_counter(Group):
    """
    Test cases for the BPNode "reset_counter" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_reset_counter(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_RESET_COUNTER with MIB_ARRAY_INDEX 2, COUNTER 10")
