...
class integration_test_bpnode_contact_teardown(Group):
    """
    Test cases for the BPNode "contact_teardown" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_contact_teardown(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_CONTACT_TEARDOWN")
