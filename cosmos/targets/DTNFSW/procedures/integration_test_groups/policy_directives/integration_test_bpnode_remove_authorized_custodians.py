...
class integration_test_bpnode_remove_auth_custodians(Group):
    """
    Test cases for the BPNode "remove_auth_custodians" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_remove_auth_custodians(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_REMOVE_AUTH_CUSTODIANS")
