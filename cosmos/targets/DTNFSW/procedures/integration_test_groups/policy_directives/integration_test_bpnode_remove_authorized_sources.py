...
class integration_test_bpnode_remove_auth_sources(Group):
    """
    Test cases for the BPNode "remove_auth_sources" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_remove_auth_sources(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_REMOVE_AUTH_SOURCES")
