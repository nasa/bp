...
class integration_test_bpnode_remove_mib_array_key(Group):
    """
    Test cases for the BPNode "remove_mib_array_key" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_remove_mib_array_key(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_REMOVE_MIB_ARRAY_KEY")
