...
class integration_test_bpnode_remove_storage_allocation(Group):
    """
    Test cases for the BPNode "remove_storage_allocation" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_remove_storage_allocation(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_REMOVE_STORAGE_ALLOCATION")
