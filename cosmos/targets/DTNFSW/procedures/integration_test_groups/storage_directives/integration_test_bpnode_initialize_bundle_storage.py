...
class integration_test_bpnode_init_bundle_storage(Group):
    """
    Test cases for the BPNode "init_bundle_storage" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_init_bundle_storage(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_INIT_BUNDLE_STORAGE")
