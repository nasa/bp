#
# Procedure: Load, validate, and activate a target table
# 
# Example usage: load_target_table("/cf/test_channel.tbl", "DTNFSW-2")
#
def load_target_table(new_tbl_file = None, target = None):
