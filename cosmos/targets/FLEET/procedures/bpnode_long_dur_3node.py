##*******************************************************************************************************************
##
## Long duration test of BPNode with Source, Relay, and Destination Nodes
##
## See Test Case DTN-FSW-cFS-LONG-0002 for setup information
##      
##*******************************************************************************************************************
import os
...
load_target_table('/cf/cha_long_src.tbl', target_1) 

## Load Contact 0 table for sending bundles on port 4556
load_target_table('/cf/con_long_src.tbl', target_1) 
...
load_target_table('/cf/pn_long_rly.tbl', target_2)

## Load Contact 0 table for sending bundles on port 4558
load_target_table('/cf/con_long_rly.tbl', target_2) 
...
CFDP_PDU_count = 2600 * number_of_contact_loops
...
while loop < number_of_contact_loops:
    ...
    RLY_BUNDLE_COUNT_RECEIVED = tlm(f"{target_2} BPNODE_NODE_MIB_COUNTERS_HK BUNDLE_COUNT_RECEIVED")
    print("Relay Node Bundles Received:", RLY_BUNDLE_COUNT_RECEIVED)
    RLY_BUNDLE_COUNT_FORWARDED = tlm(f"{target_2} BPNODE_NODE_MIB_COUNTERS_HK BUNDLE_COUNT_FORWARDED")
...
assert RLY_BUNDLE_COUNT_RECEIVED == CFDP_PDU_count
assert RLY_BUNDLE_COUNT_FORWARDED == CFDP_PDU_count
