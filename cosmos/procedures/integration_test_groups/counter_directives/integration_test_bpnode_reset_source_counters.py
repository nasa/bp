...
class integration_test_bpnode_reset_source_counters(Group):
    """
    Test cases for the BPNode "reset_source_counters" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_reset_source_counters(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_RESET_SOURCE_COUNTERS with MIB_ARRAY_INDEX 4")
