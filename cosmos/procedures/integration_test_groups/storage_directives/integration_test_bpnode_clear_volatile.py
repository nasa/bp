...
class integration_test_bpnode_clear_volatile(Group):
    """
    Test cases for the BPNode "clear_volatile" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_clear_volatile(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_CLEAR_VOLATILE")
