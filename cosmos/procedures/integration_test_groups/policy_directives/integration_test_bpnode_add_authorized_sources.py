...
class integration_test_bpnode_add_auth_sources(Group):
    """
    Test cases for the BPNode "add_auth_sources" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_add_auth_sources(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_ADD_AUTH_SOURCES")
