...
class integration_test_bpnode_add_latency(Group):
    """
    Test cases for the BPNode "add_latency" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_add_latency(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_ADD_LATENCY")
