...
class integration_test_bpnode_remove_auth_report_to_eid(Group):
    """
    Test cases for the BPNode "remove_auth_report_to_eid" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_remove_auth_report_to_eid(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_REMOVE_AUTH_REPORT_TO_EID")
