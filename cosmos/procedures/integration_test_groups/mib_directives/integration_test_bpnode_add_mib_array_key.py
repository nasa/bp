...
class integration_test_bpnode_add_mib_array_key(Group):
    """
    Test cases for the BPNode "add_mib_array_key" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_add_mib_array_key(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_ADD_MIB_ARRAY_KEY")
