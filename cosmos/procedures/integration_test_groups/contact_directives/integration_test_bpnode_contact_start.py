...
class integration_test_bpnode_contact_start(Group):
    """
    Test cases for the BPNode "contact_start" command
    - Methods beginning with script_ or test_ are added to Script dropdown
    """

    def test_bpnode_contact_start(self):
        """
        Nominal test
        """
        ...
        # Send the command
        cmd(f"<%= target_name %> BPNODE_CMD_CONTACT_START")
