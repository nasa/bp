    ...
    .ContactSet = {
        {
            ...
            .DestEIDs               = {{
                                        ...
                                        .MaxAllocator = 0,
                                        .MinAllocator = 0,
                                        .MaxNode      = BPLIB_TEMPORARY_EID_NODE_NUM_FOR_CONTACT_ROUTES,
                                        .MinNode      = BPLIB_TEMPORARY_EID_NODE_NUM_FOR_CONTACT_ROUTES,
                                        .MaxService   = BPLIB_TEMPORARY_EID_SERVICE_NUM_FOR_CONTACT_ROUTES,
                                        .MinService   = BPLIB_TEMPORARY_EID_SERVICE_NUM_FOR_CONTACT_ROUTES},
                                       {
