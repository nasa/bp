...
BPLib_PI_ChannelTable_t ChannelTable = {
    .Configs = {
        /* Channel 0 */
        {
            ...
            .IngressBitsPerCycle    = 1000000,  /* Ingress rate, 1M per cycle */
            .EgressBitsPerCycle     = 1000000,  /* Egress rate, 1Mb per cycle */
        ...
        /* Channel 1 */
        {
            ...
            .IngressBitsPerCycle    = 1000000,  /* Ingress rate, 1Mb per cycle */
            .EgressBitsPerCycle     = 1000000,  /* Egress rate, 1Mb per cycle */
            .MaxBundlePayloadSize   = BPLIB_MAX_PAYLOAD_SIZE,
            .CrcType                = BPLib_CRC_Type_CRC16,
            .BundleProcFlags        = BPLIB_BUNDLE_PROC_NO_FRAG_FLAG,
