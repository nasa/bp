...
CFE_TBL_FileDef_t CFE_TBL_FileDef = {"BP_FlowTable", "BP.FlowTable", "Configuration of bundle flows",
                                     "bp_flowtable.tbl", (sizeof(BP_FlowTblEntry_t) * BP_MAX_FLOWS)};
...
BP_FlowTbl_t BP_FlowTable = {
    .Flows = {{/* Flow 0 */
               ...
               .PktTbl    = {{CFE_SB_MSGID_WRAP_VALUE(CF_SPACE_TO_GND_PDU_MID0), 1, 1, BP_APP_READ_LIMIT}},
               .IOParm    = "OutMID=0x08BC&InMID=0x18C0&InDepth=32"},
              {/* Flow 1 */
               .Name      = "EVT",
               .Enabled   = false,
               .PipeDepth = BP_APP_READ_LIMIT,
