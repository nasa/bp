...
/**
 * \brief Send Node MIB Counters Housekeeping Packet Request
 *
 *  \par Description
 *       This function timestamps and sends the Node MIB Counters Housekeeping 
 *       Packet onto the software bus.
 *
