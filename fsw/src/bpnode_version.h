...
#define BPNODE_BUILD_NUMBER    46 /*!< Development Build: Number of commits since baseline */
 ...
 */
#define BPNODE_MAJOR_VERSION 1  /*!< @brief Major version number. */
#define BPNODE_MINOR_VERSION 1  /*!< @brief Minor version number. */
#define BPNODE_REVISION      0  /*!< @brief Revision version number. Value of 0 indicates a development version.*/

/**
 * @brief Last official release.
 */
#define BPNODE_LAST_OFFICIAL "v1.1.0"
